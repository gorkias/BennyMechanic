...
local colors = {
{name = "Siyah", colorindex = 0},{name = "Carbon Black", colorindex = 147},
{name = "Grafit", colorindex = 1},{name = "Anhracite Black", colorindex = 11},
{name = "Siyah Parlak", colorindex = 2},{name = "Dark Steel", colorindex = 3},
{name = "Gümüş", colorindex = 4},{name = "Bluish Silver", colorindex = 5},
...
------Neon layout------
	neonlayout = {
		{name = "Ön,Arka ve Yanlar", price = 500},
	},
	--Neon color
	neoncolor = {
		{ name = "Beyaz", neon = {255,255,255}, price = 500},
		{ name = "Mavi", neon = {0,0,255}, price = 500},
		{ name = "Elektrik Mavisi", neon = {0,150,255}, price = 500},
		{ name = "Nane Yeşili", neon = {50,255,155}, price = 500},
		{ name = "Limon Yeşili", neon = {0,255,0}, price = 500},
		{ name = "Sarı", neon = {255,255,0}, price = 500},
		{ name = "Golden Shower", neon = {204,204,0}, price = 500},
		{ name = "Turuncu", neon = {255,128,0}, price = 500},
		{ name = "Kırmızı", neon = {255,0,0}, price = 500},
		{ name = "Pony Pink", neon = {255,102,255}, price = 500},
		{ name = "Hot Pink",neon = {255,0,255}, price = 500},
		{ name = "Mor", neon = {153,0,153}, price = 500},
		{ name = "Kahverengi", neon = {139,69,19}, price = 500},
	},
...
------------Engine----------
	[11] = {
		{name = "Motor Güçlendirmesi, Level 2", mod = 0, price = 15000},
		{name = "Motor Güçlendirmesi, Level 3", mod = 1, price = 30000},
		{name = "Motor Güçlendirmesi, Level 4", mod = 2, price = 45000},
	},
